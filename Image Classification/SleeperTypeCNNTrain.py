...
G = args["gpus"]
datapath = '../../dataset/FirstSplitToTrainValiAndTest/TrainSetSleeperAugmented'
...
def TrainMultipleModels(ModelToUse, NumbersIfModels):
    optimizer = 'Adam'
    INIT_LR = 0.0001 #0.0015 #Bedst 0.0005
...
#TrainMultipleModels(2,3)
#TrainMultipleModels(3,3)

#TrainMultipleModels(1,1)
TrainMultipleModels(ModelNumber,1)

#TrainMultipleModels(5,5)
#TrainMultipleModels(6,5)
