...
TRAINING_IMAGES_DIR = os.getcwd() + '/trainSetFinal'#'/training_images'

# path to folder with test data but no sub folder
TEST_IMAGES_DIR = os.getcwd() + '/validationFinal' #'/testSet' #"/test_images/"

# where to save the trained graph
OUTPUT_GRAPH = os.getcwd() + '/' + 'SleeperTyperetrained_graph.pb'

# where to save the intermediate graphs
INTERMEDIATE_OUTPUT_GRAPHS_DIR = os.getcwd() + '/SleeperTypeintermediate_graph'

# how many steps to store intermediate graph, if "0" then will not store
INTERMEDIATE_STORE_FREQUENCY = 0

# where to save the trained graph's labels
OUTPUT_LABELS = os.getcwd() + '/' + 'SleeperTyperetrained_labels.txt'

# where to save summary logs for TensorBoard
TENSORBOARD_DIR = os.getcwd() + '/' + 'SleeperTypetensorboard_logs'
...
BOTTLENECK_DIR = os.getcwd() + '/' + 'SleeperTypebottleneck_data'
