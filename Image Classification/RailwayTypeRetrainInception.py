...
TEST_IMAGES_DIR = os.getcwd() + '/validationFinal'#"/test_images/"

# where to save the trained graph
OUTPUT_GRAPH = os.getcwd() + '/' + 'RailwayTyperetrained_graph.pb'

# where to save the intermediate graphs
INTERMEDIATE_OUTPUT_GRAPHS_DIR = os.getcwd() + '/RailwayTypeintermediate_graph'

# how many steps to store intermediate graph, if "0" then will not store
INTERMEDIATE_STORE_FREQUENCY = 0

# where to save the trained graph's labels
OUTPUT_LABELS = os.getcwd() + '/' + 'RailwayTyperetrained_labels.txt'

# where to save summary logs for TensorBoard
TENSORBOARD_DIR = os.getcwd() + '/' + 'RailwayTypetensorboard_logs'
...
BOTTLENECK_DIR = os.getcwd() + '/' + 'RailwayTypebottleneck_data'
