...
class parser(argparse.ArgumentParser):
    ...
    def __init__(self,description):
        ...
        self.add_argument(
            "--num_classes", "-nc", default=3, type=int,
        ...
        self.add_argument(
            "--weights_path", "-wp", default='./checkpoint/bane.weights', type=str,
        ...
        self.add_argument(
            "--image_h", "-ih", default=608, type=int,
            help="[default: %(default)s] The height of image, 416 or 608",
            metavar="<IH>",
        )

        self.add_argument(
            "--image_w", "-iw", default=608, type=int,
...
def main(argv):
    ...
    with tf.Graph().as_default() as graph:
        ...
        if flags.freeze:
            ...
            utils.freeze_graph(sess, './checkpoint/yolov3bane_cpu_nms.pb', cpu_out_node_names)
            utils.freeze_graph(sess, './checkpoint/yolov3bane_gpu_nms.pb', gpu_out_node_names)
