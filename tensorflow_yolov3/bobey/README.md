# Bobey - the Boring but Efficient-ey YOLO BBox Annotation Tool
Fast and efficient BBox annotation for your images in YOLO, and now, VOC/COCO formats!

Forked from @drainingsun - An accessible version of the in-browser annotation tool.

## INTRO
To see why and for what this was created, please read (https://medium.com/@drainingsun/boobs-yolo-bbox-annotation-tool-96fb765d0036)
...
1. Download the zip.
2. Extract it.
3. Open `bobey.html` in your browser.
