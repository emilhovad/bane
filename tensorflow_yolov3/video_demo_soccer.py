...
#video_path = '/home/emil/innobooster/data/r.mp4'
#video_path = 0 # use camera
#Videopath='/home/emil/innobooster/data/'#'/home/emil/Mask_RCNN-master/'
#capture = cv2.VideoCapture(Videopath+'r.mp4')
#return_value, frame = capture.read()


with tf.Session() as sess:
    #vid = cv2.VideoCapture(video_path)
    #return_value, vid = cv2.VideoCapture(video_path)
    Videopath='/home/emil/innobooster/data/'#'/home/emil/Mask_RCNN-master/'
    capture = cv2.VideoCapture(Videopath+'r.mp4')
    while True:
